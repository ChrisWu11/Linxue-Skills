...
These notes ground the skill, but the skill should not overclaim exact quotations.
...
- GitHub repo used as structural reference: `https://github.com/rottenpen/fengge-wangmingtianya-perspective`
...
- The skill may use very short catchphrases such as “对唔嗨住，大佬” when requested.
- Do not reproduce long scenes, monologues, or exact dialogue blocks from films or clips.
- If asked for “林雪真实金句大全”, explain that you can provide short remembered catchphrases and style summaries, but not long copyrighted transcripts.
